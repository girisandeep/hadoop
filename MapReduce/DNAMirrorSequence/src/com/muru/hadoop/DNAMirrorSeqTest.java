...
public class DNAMirrorSeqTest {
	...
	public void setUp() {
		 ...
		 */
		DNAMirrorSeqMapper mapper = new DNAMirrorSeqMapper();
		 ...
		 */
		DNAMirrorSeqReducer reducer = new DNAMirrorSeqReducer();
	...
	public void testMapReduce() throws IOException {
		...
		mapReduceDriver.addInput(new Pair<Object, Text>("1", new Text("User2 TGCA")));
		mapReduceDriver.addInput(new Pair<Object, Text>("1", new Text("User3 ACG")));
		mapReduceDriver.addInput(new Pair<Object, Text>("1", new Text("User4 ACGT")));
		mapReduceDriver.addInput(new Pair<Object, Text>("1", new Text("User5 ACG")));
		mapReduceDriver.addInput(new Pair<Object, Text>("1", new Text("User6 AGCT")));
		mapReduceDriver.addInput(new Pair<Object, Text>("1", new Text("User7 TCGA")));
